...
- `impl: {logUpdate: Function, logError: Function} = { logUpdate: realLogUpdate, logError: realLogError }` — Underlying logger; defaults to the module-level `telegram_logger` API.
